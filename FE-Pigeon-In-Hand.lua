--[[
https://www.roblox.com/catalog/9350302080/Vans-Pigeon-Shoulder-Pet
get it in https://www.roblox.com/games/6679274937/Vans-World-S2 , use this autofarm: loadstring(game:HttpGet("https://gist.githubusercontent.com/CandyWirus/276ed06ea2538efcb22cfb93ec027907/raw/d5a090897f5fbab0f38c2185420f3dd3c1ec9ccd/VansWorldSeason2.lua"))("https://v3rmillion.net/showthread.php?tid=1169072")
]]--
function rmesh(a)
...
RJ.C0=RJ.C0:Lerp(CFrame.new(0+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
RS.C0=RS.C0:Lerp(CFrame.new(1.5+0*math.cos(sine/13),0.5+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
LS.C0=LS.C0:Lerp(CFrame.new(-1.22+0*math.cos(sine/13),0.39+0*math.cos(sine/13),-0.68+0*math.cos(sine/13))*CFrame.Angles(math.rad(74.36+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(13.23+0*math.cos(sine/13))),.2) 
RH.C0=RH.C0:Lerp(CFrame.new(0.5+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
LH.C0=LH.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2)
hat('VANS_Pigeon','Left Arm',CFrame.new(0,0,0),CFrame.new(-0.005+0*math["cos"](sine/10),-1+0*math["cos"](sine/10),-0.14+0*math["cos"](sine/10))*CFrame.Angles(math.rad(74.36+0*math["cos"](sine/10)),math.rad(0+0*math["cos"](sine/10)),math.rad(180+0*math["cos"](sine/10))),false)
elseif Root.Velocity.Magnitude < 20 then -- walk
--walk clerp hereNECK.C0=NECK.C0:Lerp(CFrame.new(0+0*math.cos(sine/13),1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
RJ.C0=RJ.C0:Lerp(CFrame.new(0+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
RS.C0=RS.C0:Lerp(CFrame.new(1.5+0*math.cos(sine/13),0.5+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+30*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
LS.C0=LS.C0:Lerp(CFrame.new(-1.22+0*math.cos(sine/13),0.39+0*math.cos(sine/13),-0.68+0*math.cos(sine/13))*CFrame.Angles(math.rad(74.36+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(13.23+0*math.cos(sine/13))),.2) 
RH.C0=RH.C0:Lerp(CFrame.new(0.5+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+-30*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2) 
LH.C0=LH.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/13),-1+0*math.cos(sine/13),0+0*math.cos(sine/13))*CFrame.Angles(math.rad(0+30*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13)),math.rad(0+0*math.cos(sine/13))),.2)
