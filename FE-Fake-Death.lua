...
-- collect dolls in https://www.roblox.com/games/7541759836/unnamed to get slasher watch tutorials on YouTube
...
Mode='Attack1'
 -- time of attack u can edit thi -- change this mode to whatever u want the mode to be after attacking
end)
...
hat('Back_AccAccessory','Torso',CFrame.new(-0.1,-0.5,-1),CFrame.new(0+0*math["cos"](sine/10),0+0*math["sin"](sine/10),0+0*math["cos"](sine/10))*CFrame.Angles(math.rad(96+0*math["cos"](sine/10)),math.rad(0+0*math["cos"](sine/10)),math.rad(66+0*math["cos"](sine/10))),false)
...
RJ.C0=RJ.C0:Lerp(CFrame.new(0+0*math.cos(sine/10),-2.5+0.1*math.sin(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(91+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10))),.2) 
RS.C0=RS.C0:Lerp(CFrame.new(1.5+0*math.cos(sine/10),0.5+0.1*math.sin(sine/10),-0.14+0*math.cos(sine/10))*CFrame.Angles(math.rad(89.64+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(93+0*math.cos(sine/10))),.2) 
LS.C0=LS.C0:Lerp(CFrame.new(-1.5+0*math.cos(sine/10),0.5+0.1*math.sin(sine/10),-0.14+0*math.cos(sine/10))*CFrame.Angles(math.rad(66.64+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(68+0*math.cos(sine/10))),.2) 
RH.C0=RH.C0:Lerp(CFrame.new(0.5+0*math.cos(sine/10),-1+0*math.cos(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(0+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(6+0*math.cos(sine/10))),.2) 
LH.C0=LH.C0:Lerp(CFrame.new(-0.5+0*math.cos(sine/10),-1+0*math.cos(sine/10),0+0*math.cos(sine/10))*CFrame.Angles(math.rad(0+0*math.cos(sine/10)),math.rad(0+0*math.cos(sine/10)),math.rad(-6+0*math.cos(sine/10))),.2)
end
